      ...
      >
        <div class="registered">
          ...
          <div class="content" style="margin-top: 20px">
            ...
            <el-checkbox class="agree" v-model="agreement"> </el-checkbox>
            我已阅读并同意遵守
            <a
              @click="
                open(
...
<script>
import YFooter from "@/layout/components/Footer";
import YButton from "@/layout/components/YButton";
